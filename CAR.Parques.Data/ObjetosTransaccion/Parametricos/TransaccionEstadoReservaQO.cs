namespace CAR.Parques.Data.ObjetosTransaccion.Parametricos
{
    ...
    [Export(typeof(ITransaccionEstadoReservaQO))]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class TransaccionEstadoReservaQO : TransaccionBaseQO<EstadoReservaEO, EstadoReservaDTO>, ITransaccionEstadoReservaQO
    {
    }
}
