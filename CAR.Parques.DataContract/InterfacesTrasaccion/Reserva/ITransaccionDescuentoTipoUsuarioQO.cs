namespace CAR.Parques.DataContract.InterfacesTrasaccion.Reserva
{
    ...
    public interface ITransaccionDescuentoTipoUsuarioQO : ITransaccionBaseQO<DescuentoTipoUsuarioEO, DescuentoTipoUsuarioDTO>
    {
        ResultadoEjecucion<IEnumerable<DescuentoTipoUsuarioEO>> ConsultarDescuentoTipoUsuarioxServicio(int serviciId);
    }
}
